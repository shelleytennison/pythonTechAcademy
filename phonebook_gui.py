...
# Purpose: Phonebook project for the Tech Academy Python Course


#Be sure tp import other modules that are needed

import phonebook_main
import phonebook_func

def load_gui(self): #self allows access to all objects
